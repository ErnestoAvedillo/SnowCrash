...
Solo vemos un ejecutable asi que vamos a destriparlo
...
0x8048680:       "LOGNAME"
```
Facilmente nos damos cuenta que hace un printf con el texto que saque de la variable de entorno que en nuestro caso se llamara "LOGNAME"
